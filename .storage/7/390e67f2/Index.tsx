  ...
  return (
    <div className="min-h-screen bg-white text-zinc-900">
      ...
      <section id="contacto" className="container-max py-14 md:py-20">
        ...
        <p className="mt-3 text-zinc-600">{t.contacto.note}</p>
        <div className="mt-8 flex flex-wrap gap-3">
          <a href={`https://wa.me/${WHATSAPP_NUMBER_WA}`} target="_blank" rel="noreferrer">
            <Button className="btn-primary">{t.contacto.whatsapp}</Button>
          </a>
          <a href={`mailto:${EMAIL}`} target="_blank" rel="noreferrer">
            <Button variant="outline" className="btn-outline">{t.contacto.email}</Button>
          </a>
          <a href={RESERVAR_URL} target="_blank" rel="noreferrer">
            <Button variant="outline" className="btn-outline">{t.contacto.reservar}</Button>
          </a>
        </div>
      </section>
