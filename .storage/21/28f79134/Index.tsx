    ...
    <div className="min-h-screen bg-white text-zinc-900">
      ...
      <nav className="sticky top-0 z-50 bg-white/80 backdrop-blur supports-[backdrop-filter]:bg-white/60 border-b border-zinc-200">
        <div className="container-max flex items-center gap-4 py-3">
          ...
          {/* Menu */}
          <div className="flex items-center gap-4 ml-6 flex-nowrap whitespace-nowrap overflow-x-auto">
            <button className="text-sm md:text-base font-semibold text-zinc-700 hover:text-black" onClick={() => scrollToId('servicios')}>
              {t.menu.servicios}
            </button>
            <button className="text-sm md:text-base font-semibold text-zinc-700 hover:text-black" onClick={() => scrollToId('como')}>
              {t.menu.como}
            </button>
            <button className="text-sm md:text-base font-semibold text-zinc-700 hover:text-black" onClick={() => scrollToId('quien')}>
              {t.menu.quien}
            </button>
            <button className="text-sm md:text-base font-semibold text-zinc-700 hover:text-black" onClick={() => scrollToId('testimonios')}>
              {t.menu.testimonios}
            </button>
            <button className="text-sm md:text-base font-semibold text-zinc-700 hover:text-black" onClick={() => scrollToId('contacto')}>
              {t.menu.contacto}
            </button>
          </div>
          ...
          <Card className="border border-zinc-200 overflow-hidden">
            <CardContent className="p-0">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                ...
                />
                <img
                  src="/assets/quien-soy-physio-work.jpg"
                  alt="Fisioterapeuta profesional trabajando con paciente"
                  className="w-full h-64 md:h-full object-cover"
                  loading="lazy"
                />
              </div>
