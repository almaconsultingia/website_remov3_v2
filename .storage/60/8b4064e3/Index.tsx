    ...
    <div className="min-h-screen bg-white text-zinc-900">
      ...
      <nav className="sticky top-0 z-50 bg-white/80 backdrop-blur supports-[backdrop-filter]:bg-white/70 border-b border-zinc-200">
        <div className="container-max flex items-center gap-4 py-3">
          ...
          {/* Desktop menu: estilos claros (≥ md) */}
          ...
          <div className="max-w-2xl py-16 text-center mx-auto">
            ...
            <div className="mt-8 flex flex-wrap justify-center gap-3">
              ...
              <a href={`https://wa.me/${WHATSAPP_NUMBER_WA}`} target="_blank" rel="noreferrer">
                {/* Ajuste a botón claro como el borde: fondo blanco, borde zinc-300 */}
                <Button className="rounded-full bg-white border border-zinc-300 text-zinc-900 hover:bg-zinc-100">
                  {t.hero.whatsapp}
                </Button>
              </a>
            </div>
      ...
      {/* Quién soy - fondo alterno zinc-50, texto izquierda, imagen nueva derecha con ajuste proporcional */}
      <section id="quien" className="bg-zinc-50 text-zinc-900">
        <div className="container-max py-14 md:py-20">
          ...
          <div className="grid gap-8 md:grid-cols-2 items-center">
            ...
            {/* Derecha: nueva imagen adjunta (proporcional, sin deformar, alineada) */}
            <div className="rounded-xl ring-1 ring-zinc-200 bg-white flex items-center justify-center p-2 md:p-3">
              <img
                src="/images/photo1764701119.jpg"
                alt={lang === 'es' ? 'Fisioterapeuta en sesión - imagen actualizada' : 'Fisioterapeuta en sessió - imatge actualitzada'}
              ...
              <CardContent className="space-y-6 p-6">
                ...
                <div>
                  ...
                  <div className="mt-4 flex flex-wrap gap-3">
                    <a href={`https://wa.me/${WHATSAPP_NUMBER_WA}`} target="_blank" rel="noreferrer">
                      {/* Botón negro ya aplicado anteriormente */}
