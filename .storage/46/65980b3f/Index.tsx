      ...
      <nav className="sticky top-0 z-50 bg-black/80 backdrop-blur supports-[backdrop-filter]:bg-black/70 border-b border-white/10">
        <div className="container-max flex items-center gap-4 py-3">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="hidden md:block text-xs md:text-sm text-zinc-400">{t.tagline}</div>
          </div>

          {/* Desktop menu: sin cambios, sólo visible ≥ md */}
          <div className="hidden md:flex items-center gap-3 ml-6 flex-nowrap whitespace-nowrap">
            <button
              className="text-sm lg:text-base font-semibold text-white hover:text-zinc-200"
          ...
          <div className="flex items-center gap-3">
            <div className="hidden md:flex rounded-md border border-white/20 bg-black overflow-hidden">
              <button
        ...
        {mobileOpen && (
          <div
            ...
            className="md:hidden border-t border-white/10 bg-black/90 backdrop-blur supports-[backdrop-filter]:bg-black/70"
          >
            <div className="container-max py-2">
              <ul className="flex flex-col gap-1">
                <li>
                  <button
                    role="menuitem"
                    className="w-full text-left px-3 py-3 text-base font-medium text-white hover:bg-white/10 rounded-md"
                    onClick={() => {
                ...
                <li className="mt-1 flex gap-2 px-3">
                  <a href={RESERVAR_URL} target="_blank" rel="noreferrer" className="flex-1">
                    <Button className="w-full bg-white text-black hover:bg-zinc-200">{t.menu.reservar}</Button>
                  </a>
