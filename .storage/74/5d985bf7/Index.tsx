...
function IndexPage() {
  ...
  return (
    <div className="min-h-screen bg-white text-zinc-900">
      ...
      <nav className="sticky top-0 z-50 bg-white/80 backdrop-blur supports-[backdrop-filter]:bg-white/70 border-b border-zinc-200">
        <div className="container-max flex items-center gap-4 py-3">
          ...
          <div className="hidden md:flex items-center gap-3 ml-6 flex-nowrap whitespace-nowrap">
            <button className="text-sm lg:text-base font-semibold text-zinc-900 hover:text-zinc-700" onClick={() => scrollToId('quien')}>
              {t.menu.quien}
            </button>
            <button className="text-sm lg:text-base font-semibold text-zinc-900 hover:text-zinc-700" onClick={() => scrollToId('servicios')}>
              {t.menu.servicios}
            </button>
            <button className="text-sm lg:text-base font-semibold text-zinc-900 hover:text-zinc-700" onClick={() => scrollToId('como')}>
              {t.menu.como}
            </button>
            <button className="text-sm lg:text-base font-semibold text-zinc-900 hover:text-zinc-700" onClick={() => scrollToId('testimonios')}>
              {t.menu.testimonios}
            </button>
            <button className="text-sm lg:text-base font-semibold text-zinc-900 hover:text-zinc-700" onClick={() => scrollToId('contacto')}>
              {t.menu.contacto}
            </button>
          </div>
          ...
          <div className="flex items-center gap-3">
            <div className="hidden md:flex rounded-full border border-zinc-300 bg-white overflow-hidden">
              <button
                ...
                onClick={() => setLang('es')}
                className={`px-3 py-1.5 text-sm transition-colors ${lang === 'es' ? 'font-semibold text-zinc-900' : 'text-zinc-500'}`}
              >
                ES
              </button>
              ...
              <button
                ...
                onClick={() => setLang('cat')}
                className={`px-3 py-1.5 text-sm transition-colors ${lang === 'cat' ? 'font-semibold text-zinc-900' : 'text-zinc-500'}`}
              >
                CAT
              </button>
            </div>
        ...
        {mobileOpen && (
          <div id="mobile-menu" role="menu" aria-label="Menú principal" className="md:hidden border-t border-zinc-200 bg-white/95 backdrop-blur supports-[backdrop-filter]:bg-white/85">
            <div className="container-max py-2">
              <ul className="flex flex-col gap-1">
                <li>
                  <button role="menuitem" className="w-full text-left px-3 py-3 text-base font-medium text-zinc-900 hover:bg-zinc-100 rounded-xl" onClick={() => { scrollToId('quien'); setMobileOpen(false); }}>
                    {t.menu.quien}
                  </button>
                </li>
                <li>
                  <button role="menuitem" className="w-full text-left px-3 py-3 text-base font-medium text-zinc-900 hover:bg-zinc-100 rounded-xl" onClick={() => { scrollToId('servicios'); setMobileOpen(false); }}>
                    {t.menu.servicios}
                  </button>
                </li>
                <li>
                  <button role="menuitem" className="w-full text-left px-3 py-3 text-base font-medium text-zinc-900 hover:bg-zinc-100 rounded-xl" onClick={() => { scrollToId('como'); setMobileOpen(false); }}>
                    {t.menu.como}
                  </button>
                </li>
                <li>
                  <button role="menuitem" className="w-full text-left px-3 py-3 text-base font-medium text-zinc-900 hover:bg-zinc-100 rounded-xl" onClick={() => { scrollToId('testimonios'); setMobileOpen(false); }}>
                    {t.menu.testimonios}
                  </button>
                </li>
                <li>
                  <button role="menuitem" className="w-full text-left px-3 py-3 text-base font-medium text-zinc-900 hover:bg-zinc-100 rounded-xl" onClick={() => { scrollToId('contacto'); setMobileOpen(false); }}>
                    {t.menu.contacto}
                  </button>
                </li>
                ...
                <li className="mt-1 flex gap-2 px-3">
                  ...
                  <a href={`https://wa.me/${WHATSAPP_NUMBER_WA}`} target="_blank" rel="noreferrer" className="flex-1">
                    <Button variant="outline" className="w-full rounded-full border-zinc-300 text-zinc-900 hover:bg-zinc-100">WhatsApp</Button>
                  </a>
                </li>
              </ul>
            </div>
      ...
      {/* Hero - versión clara con overlay */}
          ...
          <div className="max-w-2xl py-16 text-center mx-auto">
            ...
            <div className="mt-8 flex flex-wrap justify-center gap-3">
              ...
              <a href={`https://wa.me/${WHATSAPP_NUMBER_WA}`} target="_blank" rel="noreferrer">
                {/* Botón claro como el borde, con borde-2 para mayor visibilidad */}
      ...
      {/* Orden de secciones solicitado: Quién soy → Servicios → Metodología → Testimonios → Contacto */}
      ...
      {/* Metodología - fondo alterno zinc-50 */}
            ...
            <Card className="bg-white border border-zinc-200 rounded-xl shadow-sm">
              ...
              <CardContent className="space-y-6 p-6">
                ...
                <div className="flex items-start gap-3 text-zinc-800">
                  <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="mt-0.5 text-zinc-700">
      ...
      <footer className="bg-white text-zinc-800 mt-0">
        <div className="container-max py-10 grid gap-8 md:grid-cols-3">
          ...
          <div>
            ...
            <ul className="mt-3 space-y-2 text-sm text-zinc-700">
              <li>
                <a href="https://www.instagram.com/remov3training/" target="_blank" rel="noreferrer" className="hover:text-zinc-900">
