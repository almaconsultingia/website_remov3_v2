...
function IndexPage() {
  ...
  return (
    <div className="min-h-screen bg-white text-zinc-900">
      ...
      {/* Quién soy - fondo alterno zinc-50, texto izquierda, imagen derecha (nueva, proporcional) */}
